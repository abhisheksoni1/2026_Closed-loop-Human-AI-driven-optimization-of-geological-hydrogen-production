# 2026_Closed-loop-Human-AI-driven-optimization-of-geological-hydrogen-production
Data and code for the manuscript on closed-loop, human-AI–driven optimization of geological hydrogen production.

This repository contains the data, optimization code, SHAP-IQ code and data analysis code associated with the manuscript and its figures.
